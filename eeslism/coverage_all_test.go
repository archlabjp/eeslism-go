...
func TestCoverage_AllComparisonCases(t *testing.T) {
	...
	testFiles := []string{
		...
		"L2_equipment/total_heat_exchanger/thex_test.txt",
		"L2_equipment/total_heat_exchanger/thex_sched_test.txt",
		"L2_equipment/total_heat_exchanger/thex_sensible_test.txt",
