...
func hexdyprt(fo io.Writer, id, Nhex int, Hex []HEX) {
	...
	default:
		for i := 0; i < Nhex; i++ {
			...
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].Qcidy.Hhr, Hex[i].Qcidy.H)
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].Qcidy.Chr, Hex[i].Qcidy.C)
			fmt.Fprintf(fo, "%1ld %2.0f ", Hex[i].Qcidy.Hmxtime, Hex[i].Qcidy.Hmx)
			fmt.Fprintf(fo, "%1ld %2.0f ", Hex[i].Qcidy.Cmxtime, Hex[i].Qcidy.Cmx)
			fmt.Fprintf(fo, "%1ld %3.1f %1ld %3.1f %1ld %3.1f ",
				Hex[i].Thidy.Hrs, Hex[i].Thidy.M,
				Hex[i].Thidy.Mntime, Hex[i].Thidy.Mn,
				Hex[i].Thidy.Mxtime, Hex[i].Thidy.Mx)
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].Qhidy.Hhr, Hex[i].Qhidy.H)
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].Qhidy.Chr, Hex[i].Qhidy.C)
			fmt.Fprintf(fo, "%1ld %2.0f ", Hex[i].Qhidy.Hmxtime, Hex[i].Qhidy.Hmx)
...
func hexmonprt(fo io.Writer, id, Nhex int, Hex []HEX) {
	...
	default:
		for i := 0; i < Nhex; i++ {
			...
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].MQcidy.Hhr, Hex[i].MQcidy.H)
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].MQcidy.Chr, Hex[i].MQcidy.C)
			fmt.Fprintf(fo, "%1ld %2.0f ", Hex[i].MQcidy.Hmxtime, Hex[i].MQcidy.Hmx)
			fmt.Fprintf(fo, "%1ld %2.0f ", Hex[i].MQcidy.Cmxtime, Hex[i].MQcidy.Cmx)
			fmt.Fprintf(fo, "%1ld %3.1f %1ld %3.1f %1ld %3.1f ",
				Hex[i].MThidy.Hrs, Hex[i].MThidy.M,
				Hex[i].MThidy.Mntime, Hex[i].MThidy.Mn,
				Hex[i].MThidy.Mxtime, Hex[i].MThidy.Mx)
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].MQhidy.Hhr, Hex[i].MQhidy.H)
			fmt.Fprintf(fo, "%1ld %3.1f ", Hex[i].MQhidy.Chr, Hex[i].MQhidy.C)
			fmt.Fprintf(fo, "%1ld %2.0f ", Hex[i].MQhidy.Hmxtime, Hex[i].MQhidy.Hmx)
